...
When we look at the percentage changes in breast cancer incidences we can gain further insights. The table below shows:

- The average percentage increase in incidences from the previous year at the 7 peaks highlighted is **94%**. 
...
cancer_incidence_borders %>% 
  ...
  mutate(yearly_pct_change = (incidences_all_ages - lag(incidences_all_ages)) / lag(incidences_all_ages) * 100) %>% 
    gt() %>%
  cols_label(
    year = "Year",
    sex = "Sex",
